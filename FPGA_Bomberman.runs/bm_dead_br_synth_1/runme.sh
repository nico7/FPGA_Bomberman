...
HD_PWD='C:/Users/Nico/Documents/Projects/Firmware/FPGA_Bomberman/FPGA_Bomberman.runs/bm_dead_br_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bm_dead_br.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bm_dead_br.tcl
