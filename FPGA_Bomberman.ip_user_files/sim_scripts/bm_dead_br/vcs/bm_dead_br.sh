...
#
# Script generated by Vivado on Thu Nov 14 03:40:15 -0500 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bm_dead_br.sh
...
#
# Usage        : bm_dead_br.sh
#                bm_dead_br.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bm_dead_br.sh [-reset_run]
#                bm_dead_br.sh [-reset_log]
#                bm_dead_br.sh [-help]
#
...
#                script (type 'bm_dead_br.sh -help' for more information).
#
...
# script info
echo -e "bm_dead_br.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bm_dead_br.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bm_dead_br xil_defaultlib.glbl -o bm_dead_br_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bm_dead_br_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bm_dead_br_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bm_dead_br_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bm_dead_br.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bm_dead_br.sh [-help]\n\
Usage: bm_dead_br.sh [-step]\n\
Usage: bm_dead_br.sh [-lib_map_path]\n\
Usage: bm_dead_br.sh [-reset_run]\n\
Usage: bm_dead_br.sh [-reset_log]\n\
Usage: bm_dead_br.sh [-keep_index]\n\
Usage: bm_dead_br.sh [-noclean_files]\n\n\
